...
//Main branch 
    private void AddADeveloperTeam() // Swtich 1
        {
            Clear();
    ...
    private void ViewAllDeveloperTeams() // Switch 2
        {
            Clear();
    ...
    private void ViewDeveloperTeamByID() //Switch 3
        {
            Clear();
    ...
    private void UpdateAnExistingDeveloperTeam() // Swtich 4
    {
        Clear();
        WriteLine("== Developer Team Listing ==");
        GetDevTeamData();
    ...
    private void DeleteAnExistingDeveloperTeam() // Switch 5
        {
            Clear();
            WriteLine("== Developer Team Listing");
            GetDevTeamData();
    ...
    private void AddMultiDevsToATeam() // Switch 6
    {
        Clear();
        WriteLine("== Developer Team Listing");
        GetDevTeamData();
...
//Side branch 
    private DeveloperTeam InitializeDTeamCreation() //Called in Switch 1,4 
    {
        try
        {
    ...
    private void DisplayDevelopersInDB(List<Developer> auxDevelopers) //Called in Switch 6 
    {
    ...
    private void SomeThingWentWrong() //Called in Switch 5 
    {
    ...
    private void ValidateDevTeamData(int userInputDevId) //Called in Switch 3 
    {
    ...
    private void GetDevTeamData() //Called in Switch 2,3,4,5,6 
    {
